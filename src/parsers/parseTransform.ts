...
export default function parseTransform(value: string): Mat33[] {
  ...
  function parseMatrixTransform(params: number[]): Mat33 {
    ...
    return new Mat33(Vec3(a, b, 0), Vec3(c, d, 0), Vec3(e, f, 1));
  }
  ...
  function parseTranslationTransform(params: number[]): Mat33 {
    ...
    return new Mat33(Vec3(1, 0, 0), Vec3(0, 1, 0), Vec3(params[0], params[1] ?? 0, 1));
  }
  ...
  function parseScale(params: number[]): Mat33 {
    ...
    return new Mat33(Vec3(params[0], 0, 0), Vec3(0, params[1] ?? params[0], 0), Vec3(0, 0, 1));
  }
  ...
  function parseSkewX(params: number[]): Mat33 {
    ...
    return new Mat33(Vec3(1, 0, 0), Vec3(Math.tan(alpha), 1, 0), Vec3(0, 0, 1));
  }
  ...
  function parseSkewY(params: number[]): Mat33 {
    ...
    return new Mat33(Vec3(1, Math.tan(alpha), 0), Vec3(0, 1, 0), Vec3(0, 0, 1));
  }
}
